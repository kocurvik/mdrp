...
def get_experiments(prefix, depths=None):
    ...
    if 'calib' in prefix:
        ...
        experiments.extend([f'mad_poselib_scale+{i}' for i in depths])
        experiments.extend([f'mad_poselib_scale_reproj+{i}' for i in depths])
        experiments.extend([f'mad_poselib_scale_reproj-s+{i}' for i in depths])
