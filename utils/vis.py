...
def get_colors_styles_fixed(results_type):
    ...
    if 'varying' in results_type:
        colors = {
            ...
            'mad_poselib_shift_scale': c[2],
            'mad_poselib_shift_scale_reproj': c[2],
            'nLO-3p_ours_scale_repeat': c[2],
            'madpose': c[2],
            '4p4d': c[3],
            '7p': c[5],
            'mast3r': c[4]
        ...
        styles = {
            ...
            'nLO-3p_ours_scale_repeat': 'dotted',
            '4p_ours_scale_shift': 'solid',
            '4p_ours_scale_shift_reproj': 'dashed',
            'mad_poselib_shift_scale': 'solid',
            'mad_poselib_shift_scale_reproj': 'dashed',
            'madpose': 'dashed',
            '4p4d': 'solid',
            '7p': 'solid',
            'mast3r': 'dotted'
